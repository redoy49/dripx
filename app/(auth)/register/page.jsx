  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#eef2ff]">
      ...
      <div
        className="
          absolute inset-0
          bg-[linear-gradient(rgba(148,163,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,255,0.1)_1px,transparent_1px)]
          bg-[size:40px_40px]
        "
      />
      ...
      <section className="relative z-10 flex min-h-screen items-center justify-center px-4 py-10">
        <div className="w-full max-w-md rounded-3xl border border-white/60 bg-white/95 p-6 shadow-[0_10px_60px_rgba(80,80,180,.12)] backdrop-blur-xl sm:p-8">
          ...
          <p className="mt-2 text-center text-sm text-gray-500">
            ...
            <a
              href="/login"
              className="ml-1 bg-gradient-to-r from-[#7f64f5] to-[#ae79f8] bg-clip-text font-medium text-transparent transition hover:opacity-80"
            >
              Log in
            </a>
          </p>
          ...
          <div className="mt-8 space-y-3">
            <button
              type="button"
              className="flex h-12 w-full cursor-pointer items-center justify-center gap-3 rounded-lg border border-gray-200 bg-white px-4 text-sm font-medium text-gray-900 transition hover:border-indigo-300 hover:shadow-md"
            >
              <GoogleIcon />
            ...
            >
              ...
              <span>Create account with Apple</span>
            </button>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 flex -translate-y-1/2 cursor-pointer items-center justify-center text-gray-400 transition hover:text-gray-700"
              >
          ...
          <div className="mt-5 text-center">
            <p className="text-xs leading-relaxed text-gray-400">
              By creating an account, you agree to DripX&apos;s{" "}
              <a
                href="#"
